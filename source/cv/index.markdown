...
Nevertheless, I never go without planning and I like working on specific non-moving targets. Focus, Focus and Focus. Agile estimating and planning (by Mike Cohn) is one of my best book on that and I come back to read it again and again. And nothing is finished if not tested and if not customers says done.
{% endblockquote %}
...
__e-rhetor (www.e-rhetor.com) - Senior Software Engineer__
